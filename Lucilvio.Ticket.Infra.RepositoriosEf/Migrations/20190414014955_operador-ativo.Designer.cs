...
namespace Lucilvio.Ticket.Infra.RepositoriosEf.Migrations
{
    ...
    [Migration("20190414014955_operador-ativo")]
    partial class operadorativo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lucilvio.Ticket.Dominio.Clientes.Cliente+Contato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Lucilvio.Ticket.Dominio.Clientes.Cliente+Contato", b =>
                {
                    b.HasOne("Lucilvio.Ticket.Dominio.Clientes.Cliente")
                        .WithMany("Contatos")
                        .HasForeignKey("ClienteId");
                });
